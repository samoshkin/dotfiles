...
alias glg="glo --date-order --graph"
alias gla="glo --date-order --graph --all"

# show left-right markers of triple dot revision syntax
# $ gllr HEAD...MERGE_HEAD
alias gllr="git log --oneline --graph --left-right --first-parent --boundary --decorate"
